...
namespace HomeKitchen.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        {
            var users = db.Users.Include(u => u.Role).Include(u => u.UserProfile);
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.Id = new SelectList(db.UserProfilies, "Id", "Surname");
            return View();
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Login,Password,Email,DateOfRegistration,Locked,RoleId")] User user)
        {
            if (ModelState.IsValid)
            {
